...
class VnxeSSH(object):
    ...
    Fantastic answer for defaultdict with multiple levels: https://stackoverflow.com/questions/38989635/why-can-a-lambda-for-collections-defaultdict-have-no-arguments
